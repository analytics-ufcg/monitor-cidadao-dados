\copy localidade_ibge FROM '/data/localidades_ibge.csv' WITH NULL AS 'NA' DELIMITER ',' CSV HEADER;
\copy municipio_sagres FROM '/data/municipios_sagres.csv' WITH NULL AS 'NA' DELIMITER ',' CSV HEADER;
\copy licitacao FROM PROGRAM 'awk FNR-1 /data/licitacoes/*.csv | cat' WITH NULL AS 'NA' DELIMITER ',' CSV;
\copy contrato FROM PROGRAM 'awk FNR-1 /data/contratos/*.csv | cat' WITH NULL AS 'NA' DELIMITER ',' CSV;
