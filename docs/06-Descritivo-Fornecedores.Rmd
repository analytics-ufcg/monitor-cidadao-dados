...
contratos_mutados_2020 <- read_delim(here::here("../dados/contratos_mutados_2020/ContratosMutadosTramita_Julho2020.csv"), ";", escape_double = FALSE, col_types = cols(cpf_cnpj = col_character(),
        data_alteracao = col_character(),
...
```{r, include=FALSE}
contratos_mutados_2020$data_mutacao <- as.Date(contratos_mutados_2020$data_mutacao)
contratos_mutados_2020$ano_rescisao <- as.numeric(format(contratos_mutados_2020$data_mutacao, "%Y"))
