...
No relatório anterior conhecemos mais sobre (características das licitações paraibanas)[http://]. Nesta análise, aprenderemos mais sobre os fornecedores da Paraíba.
...
Os **Fornecedores** podem ser caracterizdos como qualquer pessoa física ou jurídica que possua alguma relação de ordem econômica com uma Unidade Gestora. Já na entidade **Participantes** estão listados os CPFs ou CNPJs que concorreram em certames licitatórios.
