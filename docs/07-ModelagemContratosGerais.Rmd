...
Vemos que a utilização de uma técnica de balanceamento artificial aumentou a capacidade de aprendizado do modelo. 
...
O modelo eleito para utilização no Monitor Cidadão será aquele com maior valor para a AUC.
